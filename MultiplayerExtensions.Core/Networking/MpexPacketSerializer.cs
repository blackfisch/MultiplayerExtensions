...
namespace MultiplayerExtensions.Core.Networking
{
    class MpexPacketSerializer : INetworkPacketSubSerializer<IConnectedPlayer>, IInitializable, IDisposable
    {
        ...
        /// </summary>
        /// <typeparam name="TPacket">Type of packet to register. Inherits <see cref="LiteNetLib.Utils.INetSerializable"/> and <see cref="IPoolablePacket"/></typeparam>
        ...
        /// </summary>
        /// <typeparam name="TPacket">Type of packet to unregister. Inherits <see cref="LiteNetLib.Utils.INetSerializable"/> and <see cref="IPoolablePacket"/></typeparam>
        public void UnregisterCallback<TPacket>() where TPacket : INetSerializable, IPoolablePacket, new()
